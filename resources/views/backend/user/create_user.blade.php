<x-app-layout>
    ...
    <div x-cloak x-data="{ sidebarOpen: true }" class="relative flex items-start py-8">
        <!-- Side bar -->
        <section>
            <aside id="separator-sidebar" :class="{ 'w-10/12 md:w-56': sidebarOpen, 'w-0': !sidebarOpen }"
                class="fixed z-40 left-0 h-full transition-transform" aria-label="Sidebar">
                <div class="h-full py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800"
                    :class="{ 'px-3': sidebarOpen, 'px-0': !sidebarOpen }">
        ...
        <!-- Side Bar Content -->
        <section>
            <div class="fixed transition-all duration-300"
                :class="{ 'right-0 md:left-56': sidebarOpen, 'left-0': !sidebarOpen }">
                <x-hover-button
                    class="hover:bg-blue-500 text-blue-700 dark:text-blue-500 border-blue-500 m-2 transition-all duration-300"
                    @click="sidebarOpen = !sidebarOpen">
                    <x-fas-xmark x-show="sidebarOpen" class="w-4 h-4" />
                    <x-zondicon-menu x-show="!sidebarOpen" class="w-4 h-4" />
                </x-hover-button>
            </div>
        </section>

        <div class="fixed h-full overflow-y-auto transition-all duration-300 mt-14"
            :class="{ 'md:w-[calc(100%-14rem)] md:left-56': sidebarOpen, 'w-full left-0': !sidebarOpen }">
            <!-- Header  -->
            <section class="px-4">
                <div class="w-full mx-auto flex justify-between justify-items-center">
            ...
            <section class="py-4 px-4">
                <div class="max-w-screen mx-auto space-y-6" >
